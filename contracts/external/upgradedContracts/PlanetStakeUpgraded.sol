...
import {IPlanetStakeUpgraded} from "./IPlanetStakeUpgraded.sol";
import {ILRT} from "./../../tokens/erc20/ILRT.sol";

// import "hardhat/console.sol";

/**
 * @title PlanetStakeUpgraded Contract
 * @dev A contract to manages staking and rewards for Planet tokens.
 */
contract PlanetStakeUpgraded is
    Initializable,
    UUPSUpgradeable,
    IERC1155Receiver,
    ReentrancyGuardUpgradeable,
    IPlanetStakeUpgraded
{
    ...
    function stake(
        ...
        // Update staking data
        userStake.tokenId = _tokenId; //0
        userStake.quantity += _quantity; //2
