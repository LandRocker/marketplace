...
// import {IPlanetCraft} from "./IPlanetCraft.sol";
...
//  * This contract inherits from Marketplace and implements the IPlanetCraft interface.
//  */
// contract PlanetCraft is
//     Initializable,
//     UUPSUpgradeable,
...
//     IPlanetCraft
// {
//     // Use counters library for incrementing craft Ids
...
//         require(_address != address(0), "PlanetCraft::Not valid address");
//         _;
//     }
...
//         uint256 tokenId = ILandRockerERC1155(_collection).safeMint(
//             _recipient,
//             _amount
//         );
...
//      */
//     function setLandRocker1155Collection(
//         address _addr,
//         bool _isActive
...
//      * @param _isActive A boolean indicating if the collection is active for sell.
//      */
//     function setLandRocker721Collection(
//         address _addr,
//         bool _isActive
//     ) external override onlyAdmin validAddress(_addr) {
...
//      */
//     function _checkFund(uint256 price) private view {
