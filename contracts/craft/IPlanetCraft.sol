...
interface IPlanetCraft {
    ...
    /**
     * @dev Emitted when a new 1155 NFT collection is added to the marketplace.
    ...
    /**
     * @dev Emitted when a new 721 NFT collection is added to the marketplace.
     * @param collection The address of the NFT collection.
     * @param isActive A boolean indicating if the collection is active for sell.
     */
    ...
    /**
     * @dev Set whether a specific NFT collection is considered a valid NFT1155 collection in the marketplace.
     ...
     * @param _isActive A boolean indicating whether the collection is valid or not.
     */
    function setLandRocker721Collection(address _addr, bool _isActive) external;
