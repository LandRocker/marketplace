...
interface ILandRocker {
     ...
     */
    event TreasuryAddressUpdated(address _treasury);

    /**
     * @dev Emitted when the treasury address is updated.
     * @param _treasury The new treasury address.
     */
    event TreasuryAddress721Updated(address _treasury);

    /**
     * @dev Emitted when the treasury address for ERC1155 tokens is updated.
     * @param _treasury The new treasury address for ERC1155 tokens.
     */
    event TreasuryAddress1155Updated(address _treasury);
