...
import {IMinted1155Marketplace} from "./IMinted1155Marketplace.sol";
 ...
 */
contract Minted1155Marketplace is Marketplace, IMinted1155Marketplace {
     ...
     */
    function __Minted1155Marketplace_init(
    ...
    function buyItem(uint256 _sellId) external override {
        ...
        if (_lrt.balanceOf(msg.sender) >= price) {
            ...
            require(success, "Minted1155Marketplace::Unsuccessful transfer");
            //Set the listing to sold
            minted1155Sell.sellData.status = 1;

            bool isSendCreator = _lrt.transfer(minted1155Sell.seller, price);
            //Ensure that the purchased LRT tokens transfered from the marketplace contract to the seller.
            require(
                isSendCreator,
